...
export default function AuctionPage() {
  ...
  const handleRunAuction = () => {
    if (auctionResult) return // Already ran

    // Top bidder from mock data
    const topBid = auction.bids[0]
    const discount = topBid.bidAmount
    const prize = auction.chitAmount - discount
    const dividend = Math.round(discount / auction.participants)
    ...
    const result = {
      ...
      timestamp: 'Just now (Cycle 8 Closed)',
    }
        ...
        <main className="flex-1 space-y-6 p-4 sm:p-6 lg:p-8 max-w-7xl w-full mx-auto">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between pt-1">
              <div>
                ...
                <p className="mt-1 text-xs text-muted sm:text-sm">
                  Transparent reverse bidding, instant payout calculation, and tamper-evident transaction journaling.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <article className="flex flex-col justify-between rounded-[14px] border border-border bg-card p-5 shadow-(--shadow-card)">
              ...
              <div className="mt-3">
                <span className="text-2xl sm:text-3xl font-extrabold tracking-tight text-navy">
                  {initialAuctionSummary.totalCollected}
                </span>
                <p className="mt-1 text-xs font-medium text-emerald-dark">
                  Across 8 completed cycles
                </p>
              </div>
            </article>
            ...
            <article className="flex flex-col justify-between rounded-[14px] border border-border bg-card p-5 shadow-(--shadow-card)">
              ...
              <div className="mt-3">
                <span className="text-2xl sm:text-3xl font-extrabold tracking-tight text-amber-600">
                  {initialAuctionSummary.pendingAmount}
                </span>
                <p className="mt-1 text-xs font-medium text-amber-700">
                  4 installments in collection
                </p>
              </div>
            </article>
            ...
            <article className="flex flex-col justify-between rounded-[14px] border border-border bg-card p-5 shadow-(--shadow-card)">
              ...
              <div className="mt-3">
                <span className="text-2xl sm:text-3xl font-extrabold tracking-tight text-navy">
                  {initialAuctionSummary.currentCycle}
                </span>
                <p className="mt-1 text-xs font-medium text-emerald-dark">
                  ₹50,000 pool pot size
                </p>
              </div>
            </article>
          </div>
            ...
            <div className="space-y-2 pt-2">
              <div className="flex items-center justify-between text-xs font-bold text-navy">
                <span className="flex items-center gap-1.5">
                  ...
                  Live Bid Submissions (5 Bidders)
                </span>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between pb-4 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted mt-0.5">
                    Immutable transaction log &amp; tamper-evident hash journal
                  </p>
                </div>
              </div>
